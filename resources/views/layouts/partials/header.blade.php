<header class="c-header c-header-light c-header-fixed c-header-with-subheader">
    ...
    <a class="c-header-brand d-lg-none" href="#">
        <svg id="full" viewBox="0 0 376 178" class="c-icon c-icon-lg">
    ...
    <ul class="c-header-nav ml-auto mr-4">
        ...
        <li class="c-header-nav-item dropdown">
            <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <div class="c-avatar">
                    <img class="c-avatar-img" style="width: 2rem; height: 2rem; object-fit: cover;" src="https://images.unsplash.com/photo-1516726817505-f5ed825624d8?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80" alt="user@email.com" />
                </div>
            </a>
